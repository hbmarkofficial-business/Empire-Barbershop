  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Empire Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Empire Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Empire Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Empire Barbershop | Premium Barbershop Berlin" />
        <meta
